...
function useTypewriter(texts) {
  ...
  return texts[wordIdx].slice(0, charIdx);
}
    ...
    <section id="hero" className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          {personal.available && (
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full glass text-xs font-mono"
              style={{ color: '#00ff87', borderColor: 'rgba(0,255,135,0.3)', border: '1px solid' }}>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <a href="#contact" data-hover className="px-8 py-3 rounded-full glass glass-hover transition-all font-bold">
              Contact Me
            </a>
          </div>
          ...
          <div className="flex items-center space-x-6 pt-6 text-gray-500">
            <a href={personal.socials.github} data-hover target="_blank" rel="noreferrer"
              className="text-xl hover:text-[#00f3ff] transition-colors"><i className="fab fa-github" /></a>
            <a href={personal.socials.linkedin} data-hover target="_blank" rel="noreferrer"
              className="text-xl hover:text-[#7000ff] transition-colors"><i className="fab fa-linkedin" /></a>
            <a href={personal.socials.twitter} data-hover
              className="text-xl hover:text-[#ff00ea] transition-colors"><i className="fab fa-twitter" /></a>
          </div>
        </div>

        {/* Right — code card */}
        <div className="hidden lg:flex justify-center relative">
          <div className="w-96 h-96 rounded-full absolute animate-pulse"
