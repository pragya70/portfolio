...
type Personal = { email: string; location: string; github?: string | null; linkedin?: string | null; twitter?: string | null };
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  {personal.location}<br />Remote Friendly
                </p>
              </div>
            </div>
                ...
                <div className="flex space-x-4 mt-2">
                  ...
                  {personal.twitter && personal.twitter !== '#' && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-10 h-10 rounded-full flex items-center justify-center bg-white/5 hover:bg-[#ff00ea] hover:text-white transition-all"
                    >
