...
type Personal = {
  name: string; role: string; bio1: string; bio2: string;
...
export function AboutSection({ personal }: { personal: Personal }) {
  const stats: Stat[] = [
    { value: personal.statsYears, label: 'Years Exp.', color: '#00f3ff' },
    { value: personal.statsProjects, label: 'Projects', color: '#7000ff' },
    { value: personal.statsClients, label: 'Clients', color: '#ff00ea' },
  ];
